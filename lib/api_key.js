...
var APIKey = function (key, secret, user_id) {
  this.key      = (typeof key === "undefined") ? null : key;
  this.secret   = (typeof secret === "undefined") ? null : secret;
...
var createAPIKey = function (user_id) {
  ...
  // THROWS
  var base = crypto.randomBytes(16),
    secret = crypto.randomBytes(16);

  var api_key = new APIKey(user_id.toString() + "." + base.toString("base64"), secret, user_id);
